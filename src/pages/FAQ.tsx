    ...
    <div className="mb-12">
      ...
      <div className="space-y-4">
        {faqs.map((faq: { q: string; a: string }) => (
          <details key={faq.q} className="bg-white rounded-xl p-4 group shadow-sm">
            <summary className="font-medium text-navy cursor-pointer list-none flex items-center justify-between">
              {faq.q}
              <ChevronRight className="w-4 h-4 text-ocean transition-transform group-open:rotate-90 shrink-0 ml-2" />
            </summary>
    ...
    <div className="py-16 md:py-24">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          <h1 className="font-fraunces text-4xl md:text-5xl font-semibold text-navy text-center">Frequently Asked Questions</h1>
          <p className="text-center text-gray-600 mt-3">Everything you need to know about Grabb.</p>
        </motion.div>
